...
namespace e2bapp
{
	class General
	{
		...
		{
			protected static readonly string appName = "e2bapp (MySQL)";
			protected static readonly string appVer = "1.1";
			protected static readonly string appBuild = "2.24.04.08";
			...
			public MySqlConnection SqlCon
			{
				get
				{
					string server = ReadIni("Connect", "URL", "localhost");
					string port = ReadIni("Connect", "Port", "3306");
					string database = ReadIni("Connect", "Name", string.Empty);
					string user = ReadIni("Connect", "User", "root");
					string pass = ReadIni("Connect", "Pass", string.Empty);
